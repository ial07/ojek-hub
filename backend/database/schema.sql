...
CREATE TYPE user_role AS ENUM ('warehouse', 'petani', 'worker');
CREATE TYPE worker_type AS ENUM ('ojek', 'pekerja');
...
-- ===========================================
-- Additional data for workers only
...
CREATE INDEX idx_worker_profiles_type ON worker_profiles(worker_type);
